...
class YOLO():
    def __init__(self, opt):
        self.weights, self.view_img, self.imgsz, self.trace, self.conf_thres, self.iou_thres, self.agnostic, self.augment, self.nosave = \
        opt.weights, opt.view_img, opt.img_size, not opt.no_trace, opt.conf_thres, opt.iou_thres, opt.agnostic_nms, opt.augment, opt.nosave
...
def argument(w_target:str, nosave:bool):
    ...
    parser.add_argument("--nosave", default=nosave, action='store_false')
